...
//  Football Chants
//
//  Created by southrussian on 12/12/2020.
//
    ...
    private(set) var teams: [Team] = [
        ...
        Team(id: .astonVilla,
            name: "Aston Villa",
             ...
             manager: .init(name: "Unai Emeri", job: .headCoach),
        ...
        Team(id: .brighton,
             ...
             manager: .init(name: "Roberto de Zerbi", job: .headCoach),
             founded: "June 1901"),
        Team(id: .burnley,
            name: "Burnley",
             ...
             manager: .init(name: "Vensan Compani", job: .manager),
             founded: "May 1882"),
        Team(id: .chelsea,
            name: "Chelsea",
             ...
             manager: .init(name: "Mauricio Pochettino", job: .headCoach),
             founded: "March 1905"),
        Team(id: .everton,
            name: "Everton",
        ...
        Team(id: .manchesterUnited,
            name: "Manchester United",
             ...
             manager: .init(name: "Eric Ten Hag", job: .manager),
             founded: "1878"),
        Team(id: .newcastle,
            name: "Newcastle United",
             ...
             manager: .init(name: "Eddie Howe", job: .manager),
        ...
        Team(id: .tottenham,
            name: "Tottenham Hotspurs",
             ...
             manager: .init(name: "Angelos Postecoglu", job: .manager),
